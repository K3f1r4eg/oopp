...
best_lecturer_1 = Lecturer('Ignat', 'Melnikov')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Yri', 'Chepura')
best_lecturer_2.courses_attached += ['Git']

best_lecturer_3 = Lecturer('Peter', 'Bezrukov')
